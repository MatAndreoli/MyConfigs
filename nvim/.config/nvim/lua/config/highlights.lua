...
local color1_bg = colors['custom_color04']
local color2_bg = colors['custom_color02']
local color3_bg = colors['custom_color03']
local color4_bg = colors['custom_color01']
local color5_bg = colors['custom_color05']
local color6_bg = colors['custom_color08']
local color_fg = colors['custom_color07']
